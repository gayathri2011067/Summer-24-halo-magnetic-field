module equations
    ...
    subroutine diff_equations_no_split(B_r_dummy, B_phi_dummy, dBr_dummy, d2Br_dummy, dBphi_dummy, &
     d2Bphi_dummy, d_alpha_Bphi_dummy, d_alpha_Br_dummy, d_Uz_Bphi_dummy, d_Uz_Br_dummy)
      double precision, intent(in), dimension(nx) :: B_r_dummy, B_phi_dummy, dBr_dummy
      double precision, intent(in), dimension(nx) :: d2Br_dummy, dBphi_dummy, d2Bphi_dummy
      double precision, intent(in), dimension(nx) :: d_alpha_Bphi_dummy, d_alpha_Br_dummy
      double precision, intent(in), dimension(nx) :: d_Uz_Bphi_dummy, d_Uz_Br_dummy
